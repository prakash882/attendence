$(document).ready(function () {
  $error_result = $(
    '<center><label class = "text-danger">Invalid username or password</label></center>'
  );
  $error_result2 = $(
    '<center><label class = "text-danger">Please complete the required field</label></center>'
  );
